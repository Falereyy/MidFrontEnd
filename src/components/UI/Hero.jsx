        ...
        <section className='pt-0' id='about'>
            <div className='container'>
                    ...
                    <div className="w-full md:basis-1/2">
                        ...
                        className="flex items-center gap-6 mt-7">
                            ...
                            >
                                    ...
                                    This portfolio displays my work as a software developer. 
                            </p>
                <div className="flex item-center gap-9 mt-14 ">
                    ...
                    <span>
                        <a 
                        href="https://instagram.com/fallkomaling?igshid=MTk0NTkyODZkYg==" 
                    ...
                    <span>
                        <a 
                        href="https://www.facebook.com/Falerey.M.Komaling?mibextid=ZbWKwL" 
                        className="text-smallTextColor text-[15px] font-[600]"
                        >
                    ...
                    <span>
                        <a 
                        href="https://youtube.com/@falereykomaling1545?si=Dl6_fv6Hh0wo3CHN" 
                        className="text-smallTextColor text-[15px] font-[600]"
                        >
                    ...
                    <span>
                        <a 
                        href="https://github.com/Falereyy" 
                        className="text-smallTextColor text-[15px] font-[600]"
                        >
